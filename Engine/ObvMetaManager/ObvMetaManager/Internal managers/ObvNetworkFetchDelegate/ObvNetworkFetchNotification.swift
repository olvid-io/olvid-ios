...
public enum ObvNetworkFetchNotificationNew {
    ...
    case wellKnownHasBeenDownloaded(serverURL: URL, flowId: FlowIdentifier)
    ...
    private enum Name {
        ...
        private var namePrefix: String { return "ObvNetworkFetchNotificationNew" }
        
        private var nameSuffix: String {
            switch self {
            case .serverReportedThatAnotherDeviceIsAlreadyRegistered: return "serverReportedThatAnotherDeviceIsAlreadyRegistered"
            ...
            case .serverRequiresThisDeviceToRegisterToPushNotifications: return "serverRequiresThisDeviceToRegisterToPushNotifications"
            case .inboxAttachmentHasNewProgress: return "inboxAttachmentHasNewProgress"
            case .inboxAttachmentWasDownloaded: return "inboxAttachmentWasDownloaded"
            case .inboxAttachmentDownloadCancelledByServer: return "inboxAttachmentDownloadCancelledByServer"
            case .inboxAttachmentWasTakenCareOf: return "inboxAttachmentWasTakenCareOf"
            case .noInboxMessageToProcess: return "noInboxMessageToProcess"
            case .newInboxMessageToProcess: return "newInboxMessageToProcess"
            case .turnCredentialsReceived: return "turnCredentialsReceived"
            case .turnCredentialsReceptionFailure: return "turnCredentialsReceptionFailure"
            case .turnCredentialsReceptionPermissionDenied: return "turnCredentialsReceptionPermissionDenied"
            case .turnCredentialServerDoesNotSupportCalls: return "turnCredentialServerDoesNotSupportCalls"
            case .cannotReturnAnyProgressForMessageAttachments: return "cannotReturnAnyProgressForMessageAttachments"
            case .newAPIKeyElementsForCurrentAPIKeyOfOwnedIdentity: return "newAPIKeyElementsForCurrentAPIKeyOfOwnedIdentity"
            case .newAPIKeyElementsForAPIKey: return "newAPIKeyElementsForAPIKey"
            case .newFreeTrialAPIKeyForOwnedIdentity: return "newFreeTrialAPIKeyForOwnedIdentity"
            case .noMoreFreeTrialAPIKeyAvailableForOwnedIdentity: return "noMoreFreeTrialAPIKeyAvailableForOwnedIdentity"
            case .freeTrialIsStillAvailableForOwnedIdentity: return "freeTrialIsStillAvailableForOwnedIdentity"
            case .appStoreReceiptVerificationFailed: return "appStoreReceiptVerificationFailed"
            case .appStoreReceiptVerificationSucceededAndSubscriptionIsValid: return "appStoreReceiptVerificationSucceededAndSubscriptionIsValid"
            ...
            case .wellKnownHasBeenUpdated: return "wellKnownHasBeenUpdated"
            case .wellKnownHasBeenDownloaded: return "wellKnownHasBeenDownloaded"
            case .wellKnownDownloadFailure: return "wellKnownDownloadFailure"
            case .apiKeyStatusQueryFailed: return "apiKeyStatusQueryFailed"
            case .applicationMessageDecrypted: return "applicationMessageDecrypted"
            case .downloadingMessageExtendedPayloadWasPerformed: return "downloadingMessageExtendedPayloadWasPerformed"
            case .downloadingMessageExtendedPayloadFailed: return "downloadingMessageExtendedPayloadFailed"
            }
        }
    ...
    public static let serverReportedThatAnotherDeviceIsAlreadyRegisteredName = Name.serverReportedThatAnotherDeviceIsAlreadyRegistered.name
    public static let noInboxMessageToProcessName = Name.noInboxMessageToProcess.name
    public static let newInboxMessageToProcessName = Name.newInboxMessageToProcess.name
    ...
    private var userInfo: [AnyHashable: Any]? {
        ...
        case .newAPIKeyElementsForCurrentAPIKeyOfOwnedIdentity(ownedIdentity: let ownedIdentity, apiKeyStatus: let apiKeyStatus, apiPermissions: let apiPermissions, apiKeyExpirationDate: let apiKeyExpirationDate):
            ...
            if apiKeyExpirationDate != nil {
                info?["apiKeyExpirationDate"] = apiKeyExpirationDate!
            }
        ...
        case .wellKnownHasBeenDownloaded(serverURL: let serverURL, flowId: let flowId):
            info = [
                "serverURL": serverURL,
                "flowId": flowId,
            ]
    ...
    public static func observeNewAPIKeyElementsForAPIKey(within notificationDelegate: ObvNotificationDelegate, queue: OperationQueue? = nil, block: @escaping (URL, UUID, APIKeyStatus, APIPermissions, Date?) -> Void) -> NSObjectProtocol {
        ...
        return notificationDelegate.addObserver(forName: name, queue: queue) { (notification) in
            ...
            let apiKeyExpirationDate = notification.userInfo!["apiKeyExpirationDate"] as! Date?
    ...
    public static func observeWellKnownHasBeenDownloaded(within notificationDelegate: ObvNotificationDelegate, queue: OperationQueue? = nil, block: @escaping (URL, FlowIdentifier) -> Void) -> NSObjectProtocol {
