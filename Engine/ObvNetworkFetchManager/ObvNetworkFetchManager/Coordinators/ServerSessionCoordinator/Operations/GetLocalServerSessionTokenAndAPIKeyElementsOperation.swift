...
final class GetLocalServerSessionTokenAndAPIKeyElementsOperation: ContextualOperationWithSpecificReasonForCancel<GetLocalServerSessionTokenAndAPIKeyElementsOperation.ReasonForCancel> {
