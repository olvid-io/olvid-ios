...
final class ResetServerSessionCorrespondingToInvalidTokenOperation: ContextualOperationWithSpecificReasonForCancel<ResetServerSessionCorrespondingToInvalidTokenOperation.ReasonForCancel> {
