...
final class CleanExistingInboxAttachmentSessionsOperation: ContextualOperationWithSpecificReasonForCancel<CleanExistingInboxAttachmentSessionsOperation.ReasonForCancel> {
