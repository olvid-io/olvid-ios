...
final class ResumeTaskForGettingAttachmentSignedURLsOperation: Operation {
    ...
    init(attachmentId: AttachmentIdentifier, logSubsystem: String, obvContext: ObvContext, identityDelegate: ObvIdentityDelegate, attachmentChunksSignedURLsTracker: AttachmentChunksSignedURLsTracker, delegate: FinalizeSignedURLsOperationsDelegate) {
