...
final class ResumeTaskForGettingAttachmentSignedURLsOperation: Operation {
    ...
    init(attachmentId: ObvAttachmentIdentifier, logSubsystem: String, obvContext: ObvContext, identityDelegate: ObvIdentityDelegate, attachmentChunksSignedURLsTracker: AttachmentChunksSignedURLsTracker, delegate: FinalizeSignedURLsOperationsDelegate) {
    ...
    override func main() {
        ...
        obvContext.performAndWait {
            ...
            guard !attachment.allChunksHaveSignedURLs else {
            ...
            // Create a method
            let method = RefreshInboxAttachmentSignedUrlServerMethod(identity: identity, attachmentId: attachmentId, expectedChunkCount: attachment.chunks.count, flowId: flowId)
            method.identityDelegate = self.identityDelegate
