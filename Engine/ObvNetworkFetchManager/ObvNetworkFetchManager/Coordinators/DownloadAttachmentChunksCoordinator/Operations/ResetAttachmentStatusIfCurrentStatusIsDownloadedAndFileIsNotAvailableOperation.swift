...
final class ResetAttachmentStatusIfCurrentStatusIsDownloadedAndFileIsNotAvailableOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel> {
