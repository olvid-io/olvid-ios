...
final class CreateChunksProgressesForAttachmentOperation: ContextualOperationWithSpecificReasonForCancel<CreateChunksProgressesForAttachmentOperation.ReasonForCancel> {
