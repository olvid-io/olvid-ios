...
final class MarkInboxMessageAndAttachmentsForDeletionAndCreatePendingDeleteFromServerIfAppropriateOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel> {
    ...
    override func main(obvContext: ObvContext, viewContext: NSManagedObjectContext) {
        do {
            ...
            try inboxMessage.markMessageAndAttachmentsForDeletionAndCreatePendingDeleteFromServerIfAppropriate(attachmentToMarkForDeletion: attachmentToMarkForDeletion, within: obvContext)
