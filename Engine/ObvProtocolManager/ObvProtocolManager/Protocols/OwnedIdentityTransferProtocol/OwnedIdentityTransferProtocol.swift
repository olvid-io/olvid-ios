...
public struct OwnedIdentityTransferProtocol: ConcreteCryptoProtocol {
    
    static let logCategory = "OwnedIdentityTransferProtocol"
    
    static let id = CryptoProtocolId.ownedIdentityTransfer
