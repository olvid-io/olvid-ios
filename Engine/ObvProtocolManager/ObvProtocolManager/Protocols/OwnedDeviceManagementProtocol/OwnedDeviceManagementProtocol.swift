...
public struct OwnedDeviceManagementProtocol: ConcreteCryptoProtocol {
    
    static let logCategory = "OwnedDeviceManagementProtocol"
    
    static let id = CryptoProtocolId.ownedDeviceManagement
    
    static let finalStateIds: [ConcreteProtocolStateId] = [StateId.cancelled, StateId.serverQueryProcessed]
