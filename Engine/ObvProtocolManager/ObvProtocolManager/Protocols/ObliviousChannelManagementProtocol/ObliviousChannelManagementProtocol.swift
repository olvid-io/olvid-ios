...
public struct ObliviousChannelManagementProtocol: ConcreteCryptoProtocol {
    
    static let logCategory = "ObliviousChannelManagementProtocol"
    
    static let id = CryptoProtocolId.ObliviousChannelManagement
