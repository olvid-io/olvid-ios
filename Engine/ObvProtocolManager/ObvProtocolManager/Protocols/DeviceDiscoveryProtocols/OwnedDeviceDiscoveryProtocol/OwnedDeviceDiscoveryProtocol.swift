...
public struct OwnedDeviceDiscoveryProtocol: ConcreteCryptoProtocol {
    
    static let logCategory = "OwnedDeviceDiscoveryProtocol"
    
    static let id = CryptoProtocolId.ownedDeviceDiscovery
