...
public final class ObvServerDeleteUserDataMethod: ObvServerDataMethod {

    static let log = OSLog(subsystem: "io.olvid.server.interface.ObvServerDeleteUserDataMethod", category: "ObvServerInterface")

    public let pathComponent = "/deleteUserData"
    ...
    lazy public var dataToSend: Data? = {
        ...
        return [self.ownedIdentity, self.token, binaryServerLabel].encode().rawData
    }()
