...
public final class ObvServerPutGroupLogServerMethod: ObvServerDataMethod { 
        
    static let log = OSLog(subsystem: "io.olvid.server.interface.ObvServerPutGroupLogServerMethod", category: "ObvServerInterface")
