...
fileprivate let debugPrintPrefix = "[\(errorDomain)][OutboxMessageUploadHistoryToOutboxMessageUploadHistoryMigrationPolicyV20ToV21]"

final class OutboxMessageUploadHistoryToOutboxMessageUploadHistoryMigrationPolicyV20ToV21: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let dInstance = try initializeDestinationInstance(forEntityName: "OutboxMessageUploadHistory",
                                                          forSource: sInstance,
                                                          in: mapping,
                                                          manager: manager,
