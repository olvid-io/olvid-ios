...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PendingDeleteFromServerToPendingDeleteFromServerMigrationPolicyV20ToV21]"

final class PendingDeleteFromServerToPendingDeleteFromServerMigrationPolicyV20ToV21: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let dInstance = try initializeDestinationInstance(forEntityName: "PendingDeleteFromServer",
                                                          forSource: sInstance,
                                                          in: mapping,
                                                          manager: manager,
