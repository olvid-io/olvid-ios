...
fileprivate let debugPrintPrefix = "[\(errorDomain)][MessageHeaderToMessageHeaderMigrationPolicyV20ToV21]"

final class MessageHeaderToMessageHeaderMigrationPolicyV20ToV21: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let dInstance = try initializeDestinationInstance(forEntityName: "MessageHeader",
                                                          forSource: sInstance,
                                                          in: mapping,
                                                          manager: manager,
