...
final class OutboxAttachmentUploadHistoryToOutboxAttachmentUploadHistoryMigrationPolicyV20ToV21: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let dInstance = try initializeDestinationInstance(forEntityName: "OutboxAttachmentUploadHistory",
                                                          forSource: sInstance,
                                                          in: mapping,
                                                          manager: manager,
