...
fileprivate let debugPrintPrefix = "[\(errorDomain)][InboxMessageToInboxMessageMigrationPolicyV20ToV21]"

final class InboxMessageToInboxMessageMigrationPolicyV20ToV21: NSEntityMigrationPolicy {
