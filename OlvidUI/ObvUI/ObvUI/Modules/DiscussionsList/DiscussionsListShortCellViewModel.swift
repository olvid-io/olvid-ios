...
public class DiscussionsListShortCellViewModel: NSObject {
    ...
    public init(numberOfNewReceivedMessages: Int, circledInitialsConfig: CircledInitialsConfiguration?, shouldMuteNotifications: Bool, title: String) {
