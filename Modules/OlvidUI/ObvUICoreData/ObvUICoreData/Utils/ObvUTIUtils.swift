...
public final class ObvUTIUtils {
    
    public static let kUTTypeOlvidBackup = "io.olvid.type.olvidbackup" as CFString
    ...
    public static func utiOfFile(atURL url: URL) -> String? {
    ...
    public static func utiOfFile(withName fileName: String) -> String? {
        let fileExtension = NSString.init(string: fileName).pathExtension
        return utiOfFile(withExtension: fileExtension)
    }
    
    public static func preferredTagWithClass(inUTI uti: String, inTagClass tagClass: TagClass) -> String? {
    ...
    public static func uti(_ uti: String, conformsTo conformingUTI: CFString) -> Bool {
        return UTTypeConformsTo(uti as CFString, conformingUTI)
    }
    
    
    public static func jpegExtension() -> String {
    ...
    public static func pngExtension() -> String {
    ...
    public static func guessUTIOfBinaryFile(atURL url: URL) -> String? {
    ...
    public static func getHumanReadableType(forUTI uti: String) -> String? {
        switch uti {
