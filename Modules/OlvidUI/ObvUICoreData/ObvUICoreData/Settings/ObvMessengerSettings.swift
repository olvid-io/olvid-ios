...
public struct ObvMessengerSettings {
    ...
    public struct ContactsAndGroups {
        ...
        public static var autoAcceptGroupInviteFrom: AutoAcceptGroupInviteFrom {
            get {
    ...
    public struct Interface {
        ...
        public static var useOldDiscussionInterface: Bool {
            get {
    ...
    public struct Discussions {
        ...
        public static var doSendReadReceipt: Bool {
            get {
    ...
    public struct Privacy {
        ...
        public static var localAuthenticationPolicy: LocalAuthenticationPolicy {
            get {
    ...
    public struct VoIP {
        ...
        public static var isCallKitEnabled: Bool {
            get {
                guard ObvUICoreDataConstants.isRunningOnRealDevice else { return false }
                return userDefaults.boolOrNil(forKey: "settings.voip.isCallKitEnabled") ?? true
            }
            set {
                guard ObvUICoreDataConstants.isRunningOnRealDevice else { return }
