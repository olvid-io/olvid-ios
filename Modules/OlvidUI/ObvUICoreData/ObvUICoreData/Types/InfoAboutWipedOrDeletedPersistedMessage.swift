...
public struct InfoAboutWipedOrDeletedPersistedMessage {
    ...
    public init(kind: WipedOrDeleted, discussionPermanentID: ObvManagedObjectPermanentID<PersistedDiscussion>, messagePermanentID: ObvManagedObjectPermanentID<PersistedMessage>) {
        self.kind = kind
    ...
    public static func notifyThatMessagesWereWipedOrDeleted(_ infos: [InfoAboutWipedOrDeletedPersistedMessage]) {
    ...
    public static func refresh(viewContext: NSManagedObjectContext, _ infos: [InfoAboutWipedOrDeletedPersistedMessage]) {
        viewContext.perform {
