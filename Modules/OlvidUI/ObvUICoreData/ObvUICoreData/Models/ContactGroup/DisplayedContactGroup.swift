...
public final class DisplayedContactGroup: NSManagedObject, ObvErrorMaker, Identifiable, ObvIdentifiableManagedObject {
    ...
    public static let errorDomain = "DisplayedContactGroup"
    
    private let log = OSLog(subsystem: ObvUICoreDataConstants.logSubsystem, category: String(describing: DisplayedContactGroup.self))
