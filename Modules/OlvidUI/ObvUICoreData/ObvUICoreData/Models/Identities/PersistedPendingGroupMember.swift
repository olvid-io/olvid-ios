...
public final class PersistedPendingGroupMember: NSManagedObject, ObvErrorMaker {
    
    private static let entityName = "PersistedPendingGroupMember"
    public static let errorDomain = "PersistedPendingGroupMember"
    
    // MARK: Attributes
    
    @NSManaged public var declined: Bool
