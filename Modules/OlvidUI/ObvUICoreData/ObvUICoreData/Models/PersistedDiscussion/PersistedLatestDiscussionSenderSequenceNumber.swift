...
public final class PersistedLatestDiscussionSenderSequenceNumber: NSManagedObject, ObvErrorMaker {

    private static let entityName = "PersistedLatestDiscussionSenderSequenceNumber"
    public static let errorDomain = "PersistedLatestDiscussionSenderSequenceNumber"

    // MARK: Attributes

    @NSManaged public private(set) var latestSequenceNumber: Int
    ...
    public convenience init?(discussion: PersistedDiscussion,
    ...
    public func updateLatestSequenceNumber(with latestSequenceNumber: Int) {
        self.latestSequenceNumber = latestSequenceNumber
    }
    ...
    public static func get(discussion: PersistedDiscussion, contactIdentity: PersistedObvContactIdentity, senderThreadIdentifier: UUID) throws -> PersistedLatestDiscussionSenderSequenceNumber? {
