...
public final class PersistedDiscussionLocalConfiguration: NSManagedObject, ObvErrorMaker {
    
    private static let entityName = "PersistedDiscussionLocalConfiguration"
    public static let errorDomain = "PersistedDiscussionLocalConfiguration"
