...
public final class PersistedMessageSentRecipientInfos: NSManagedObject, ObvErrorMaker {
    ...
    public static let errorDomain = "PersistedMessageSentRecipientInfos"
    private let log = OSLog(subsystem: ObvUICoreDataConstants.logSubsystem, category: "PersistedMessageSentRecipientInfos")
    ...
    public func setMessageIdentifierFromEngine(to messageIdentifierFromEngine: Data, andReturnReceiptElementsTo elements: (nonce: Data, key: Data)) {
    ...
    public func setTimestampMessageSent(to timestamp: Date) {
    ...
    public static func getAllPersistedMessageSentRecipientInfosWithoutTimestampDeliveredAndMatching(messageIdentifierFromEngine: Data, ownedCryptoId: ObvCryptoId, within context: NSManagedObjectContext) throws -> [PersistedMessageSentRecipientInfos] {
        let request: NSFetchRequest<PersistedMessageSentRecipientInfos> = PersistedMessageSentRecipientInfos.fetchRequest()
        request.predicate = NSCompoundPredicate(andPredicateWithSubpredicates: [
    ...
    public static func get(withNonce nonce: Data, ownedCryptoId: ObvCryptoId, within context: NSManagedObjectContext) throws -> Set<PersistedMessageSentRecipientInfos> {
        let request: NSFetchRequest<PersistedMessageSentRecipientInfos> = PersistedMessageSentRecipientInfos.fetchRequest()
        request.predicate = NSCompoundPredicate(andPredicateWithSubpredicates: [
