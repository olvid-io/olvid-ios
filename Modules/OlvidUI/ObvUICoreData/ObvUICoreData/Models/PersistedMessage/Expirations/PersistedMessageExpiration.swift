...
public class PersistedMessageExpiration: NSManagedObject, ObvErrorMaker {
    
    private static let entityName = "PersistedMessageExpiration"
    public static let errorDomain = "PersistedMessageExpiration"
...
extension PersistedMessageExpiration {
    ...
    public static func getEarliestExpiration(laterThan date: Date, within context: NSManagedObjectContext) throws -> PersistedMessageExpiration? {
