...
public struct ObvUICoreDataConstants {
    ...
    public enum ContainerURL: CaseIterable {
        ...
        public static var securityApplicationGroupURL: URL {
            FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: ObvUICoreDataConstants.appGroupIdentifier)!.resolvingSymlinksInPath()
        }
        ...
        public var url: URL {
            ...
            case .forMessagesDecryptedWithinNotificationExtension:
                return Self.securityApplicationGroupURL.appendingPathComponent("MessagesDecryptedWithinNotificationExtension", isDirectory: true)
            case .forCache:
            ...
            case .forNotificationAttachments:
                return Self.securityApplicationGroupURL.appendingPathComponent("NotificationAttachments", isDirectory: true)
            case .forFylesHardlinksWithinMainApp:
