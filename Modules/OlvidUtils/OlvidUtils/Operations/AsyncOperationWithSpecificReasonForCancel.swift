...
open class AsyncOperationWithSpecificReasonForCancel<ReasonForCancelType: LocalizedErrorWithLogType>: OperationWithSpecificReasonForCancel<ReasonForCancelType> {
