...
final class SubscriptionPlansViewModel: SubscriptionPlansViewModelProtocol {
    
    let ownedCryptoId: ObvCryptoId
    let showFreePlanIfAvailable: Bool
    @Published private(set) var freePlanIsAvailable: Bool? = nil
    @Published private(set) var products: [Product]? = nil
    
    init(ownedCryptoId: ObvCryptoId, showFreePlanIfAvailable: Bool) {
...
protocol SubscriptionPlansViewModelProtocol: ObservableObject {
...
protocol SubscriptionPlansViewActionsProtocol: AnyObject {
...
protocol SubscriptionPlansViewDismissActionsProtocol {
    func userWantsToDismissSubscriptionPlansView() async
    func dismissSubscriptionPlansViewAfterPurchaseWasMade() async
}

struct SubscriptionPlansView<Model: SubscriptionPlansViewModelProtocol>: View, NewSKProductCardViewActionsProtocol, BottomButtonsViewActionsProtocol {
                        ...
                        if let fetchErrorShown {
                            ...
                            if let buyErrorShown {
                                ...
                                if freePlanIsAvailable && model.showFreePlanIfAvailable {
                                    NewSKProductCardView(model: .init(title: NSLocalizedString("TRY_SECURE_CALLS", comment: ""),
                                                                      price: NSLocalizedString("Free", comment: ""),
                                                                      description: NSLocalizedString("TRY_SECURE_CALLS_DESCRIPTION", comment: ""),
                                                                      buttonTitle: NSLocalizedString("Start free trial now", comment: ""),
                                ...
                                ForEach(products, id: \.self) { product in
                                    NewSKProductCardView(model: .init(product: product,
                                                                      ...
                                                                      buttonTitle: NSLocalizedString("Subscribe now", comment: ""),
...
fileprivate enum BuyError: Error, LocalizedError {
    ...
    var localizedDescription: String {
        switch self {
        case .buySucceededButSubscriptionIsExpired:
            return NSLocalizedString("BUY_SUCCEEDED_BUT_SUBSCRIPTION_EXPIRED", comment: "")
        case .buyFailed:
            return NSLocalizedString("BUY_FAILED", comment: "")
        case .failedToStartFreeTrial:
            return NSLocalizedString("FAILED_TO_START_FREE_TRIAL", comment: "")
        case .couldNotRestorePurchases(error: let error):
            return String(format: NSLocalizedString("FAILED_TO_RESTORE_PURCHASES_%@", comment: ""), error.localizedDescription)
        case .purchaseNotAllowed:
            return NSLocalizedString("USER_CANNOT_MAKE_PAYMENT_DESCRIPTION", comment: "")
        case .otherError(error: let error):
            return String(format: NSLocalizedString("Sorry, the purchase failed 😢. Please try again later or contact us if this problem is recurring. %@", comment: ""), error.localizedDescription)
        case .productUnavailable:
            return NSLocalizedString("Sorry, the product is not available in your store 😢.", comment: "")
        }
    }
}
