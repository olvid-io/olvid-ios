...
struct DateInfosOfSentMessageToManyContactsInnerView: View {
    ...
    var body: some View {
        if !read.isEmpty {
            Section(header: ObvLabel("Read", systemIcon: .eyeFill), content: {
        ...
        if !delivered.isEmpty {
            Section(header: ObvLabel("Delivered", systemIcon: .checkmarkCircleFill), content: {
        ...
        if !sent.isEmpty {
            Section(header: ObvLabel("Sent", systemIcon: .checkmarkCircle), content: {
        ...
        if !pending.isEmpty {
            Section(header: ObvLabel("Pending", systemIcon: .hourglass), content: {
        ...
        if !failed.isEmpty {
            Section(header: ObvLabel("Failed", systemIcon: .exclamationmarkCircle), content: {
