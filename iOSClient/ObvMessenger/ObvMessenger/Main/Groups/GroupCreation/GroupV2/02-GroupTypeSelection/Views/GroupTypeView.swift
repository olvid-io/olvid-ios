...
final class GroupTypeViewModel<ContactModel: SingleContactViewModelProtocol>: HorizontalContactsViewModelProtocol {

    let canEditContacts = false
    let orderedContacts: [ContactModel]
    let preselectedGroupType: GroupTypeValue?

    init(orderedContacts: [ContactModel], preselectedGroupType: GroupTypeValue?) {
...
struct GroupTypeView<ContactModel: SingleContactViewModelProtocol>: View {
    
    let model: GroupTypeViewModel<ContactModel>
...
struct GroupTypeView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        GroupTypeView(model: .init(orderedContacts: [PersistedObvContactIdentity](), preselectedGroupType: nil), actions: actionsForPreview)
