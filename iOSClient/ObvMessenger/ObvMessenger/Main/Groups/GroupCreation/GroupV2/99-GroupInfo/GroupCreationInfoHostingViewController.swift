...
final class GroupInfoViewModel: GroupInfoViewModelProtocol {
    ...
    init(orderedContacts: [PersistedObvContactIdentity], initialName: String?, initialDescription: String?, initialCircledInitialsConfiguration: CircledInitialsConfiguration?, editOrCreate: GroupInfoViewEditOrCreate) {
