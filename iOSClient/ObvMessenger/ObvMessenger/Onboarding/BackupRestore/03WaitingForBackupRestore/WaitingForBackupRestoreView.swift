...
struct WaitingForBackupRestoreView: View {
    ...
    private enum DefaultError: LocalizedError {
        ...
        var errorDescription: String {
            switch self {
            case .couldNotEnableAutomaticBackup:
                return NSLocalizedString("AUTOMATIC_BACKUP_COULD_NOT_BE_ENABLED_TITLE", comment: "")
            case .genericError:
                return NSLocalizedString("ERROR", comment: "")
            }
        }
        var recoverySuggestion: String {
            return NSLocalizedString("PLEASE_TRY_AGAIN_LATER", comment: "")
        }
    }
            ...
            case .restoreSucceeded:
                ...
                VStack {
                    ...
                    VStack {
                        ...
                        HStack {
                            Spacer()
                            Button("Later", action: backupRestorationSucceeded)
                        }
                    }.padding()
                }
