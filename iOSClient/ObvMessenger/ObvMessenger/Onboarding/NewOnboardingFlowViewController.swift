...
protocol NewOnboardingFlowViewControllerDelegate: AnyObject, SubscriptionPlansViewActionsProtocol {
...
public struct Onboarding {
    ...
    public enum Mode {
        ...
        case addNewDevice(ownedCryptoId: ObvCryptoId, ownedDetails: CNContact)
        case addProfile
    ...
    public struct KeycloakConfiguration {
        let keycloakServerURL: URL // Keycloak server URL
        let clientId: String
    ...
    public struct MDMConfiguration {
        let keycloakConfiguration: KeycloakConfiguration
    }
...
public final class NewOnboardingFlowViewController: UIViewController, NewWelcomeScreenViewControllerDelegate, NewUnmanagedDetailsChooserViewControllerDelegate, NewAutorisationRequesterViewControllerDelegate, NewOwnedIdentityGeneratedViewControllerDelegate, UINavigationControllerDelegate, ChooseBetweenBackupRestoreAndAddThisDeviceViewControllerDelegate, ChooseBackupFileViewControllerDelegate, EnterBackupKeyViewControllerDelegate, WaitingForBackupRestoreViewControllerDelegate, ScannerHostingViewDelegate, IdentityProviderValidationViewControllerDelegate, OlvidURLHandler, ManagedDetailsViewerViewControllerDelegate, TransfertProtocolSourceCodeDisplayerViewControllerDelegate, AddProfileViewControllerDelegate, CurrentDeviceNameChooserViewControllerDelegate, TransfertProtocolTargetCodeFormViewControllerDelegate, TransferProtocolTargetShowSasViewControllerDelegate, SuccessfulTransferConfirmationViewControllerDelegate, InputSASOnSourceViewControllerDelegate, ChooseDeviceToKeepActiveViewControllerDelegate, OwnedIdentityTransferSummaryViewControllerDelegate, NewIdentityProviderManualConfigurationViewControllerDelegate, UIAdaptivePresentationControllerDelegate {
    ...
    private func showFirstOnboardingScreen() {
        ...
        case .addNewDevice(let ownedCryptoId, let ownedDetails):
    ...
    func userWantsToAuthenticateOnKeycloakServer(controller: IdentityProviderValidationViewController, keycloakConfiguration: Onboarding.KeycloakConfiguration, isConfiguredFromMDM: Bool, keycloakServerKeyAndConfig: (jwks: ObvJWKSet, serviceConfig: OIDServiceConfiguration)) async throws {
        guard let delegate else { throw ObvError.theDelegateIsNotSet }
    ...
    func userWantsToCreateProfileWithDetailsFromIdentityProvider(controller: ManagedDetailsViewerViewController, keycloakDetails: (keycloakUserDetailsAndStuff: KeycloakUserDetailsAndStuff, keycloakServerRevocationsAndStuff: KeycloakServerRevocationsAndStuff), keycloakState: ObvKeycloakState) async {
        ...
        do {
            ...
            let alert = UIAlertController(title: NSLocalizedString("DIALOG_TITLE_IDENTITY_PROVIDER_ERROR", comment: "") ,
                                          message: NSLocalizedString("DIALOG_MESSAGE_FAILED_TO_UPLOAD_IDENTITY_TO_KEYCLOAK", comment: ""),
    ...
    @MainActor
    func userWantsToValidateManualKeycloakConfiguration(controller: NewIdentityProviderManualConfigurationViewController, keycloakConfig: Onboarding.KeycloakConfiguration) async {
    ...
    func handleOlvidURL(_ olvidURL: OlvidURL) async {
        ...
        case .configuration(let serverAndAPIKey, _, let keycloakConfig):
            ...
            if let serverAndAPIKey {
                ...
                let keycloakConfiguration = Onboarding.KeycloakConfiguration(keycloakServerURL: keycloakConfig.serverURL, clientId: keycloakConfig.clientId, clientSecret: keycloakConfig.clientSecret)
                self.internalState = .keycloakConfigAvailable(keycloakConfiguration: keycloakConfiguration, isConfiguredFromMDM: false)
                await showNextOnboardingScreen(animated: true)
            } else {
                assertionFailure()
    ...
    private func userWantsToUseCustomServerAndAPIKey(_ customServerAndAPIKey: ServerAndAPIKey) async {
        ...
        let title = NSLocalizedString("USE_CUSTOM_API_KEY_AND_SERVER_ALERT_TITLE", comment: "")
        let message = String.localizedStringWithFormat(NSLocalizedString("USE_CUSTOM_API_KEY_AND_SERVER_ALERT_BODY_%@_%@", comment: ""), customServerAndAPIKey.server.absoluteString, customServerAndAPIKey.apiKey.uuidString)
    ...
    private func getConfiguredEllipsisCircleRightBarButtonItem() -> UIBarButtonItem {
        let menuElements: [UIMenuElement] = [
            UIAction(title: NSLocalizedString("PASTE_CONFIGURATION_LINK", comment: ""),
            ...
            UIAction(title: NSLocalizedString("MANUAL_CONFIGURATION", comment: ""),
