...
protocol IdentityProviderValidationViewActionsProtocol: AnyObject {
    ...
    func userWantsToAuthenticateOnKeycloakServer(keycloakConfiguration: Onboarding.KeycloakConfiguration, isConfiguredFromMDM: Bool, keycloakServerKeyAndConfig: (jwks: ObvJWKSet, serviceConfig: OIDServiceConfiguration)) async throws
}
