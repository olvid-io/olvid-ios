...
protocol TransfertProtocolSourceCodeDisplayerViewActionsProtocol: AnyObject {
    ...
    func userWantsToInitiateOwnedIdentityTransferProtocolOnSourceDevice(ownedCryptoId: ObvCryptoId, onAvailableSessionNumber: @escaping (ObvOwnedIdentityTransferSessionNumber) -> Void, onAvailableSASExpectedOnInput: @escaping (ObvOwnedIdentityTransferSas, String, UID) -> Void) async throws
...
struct TransfertProtocolSourceCodeDisplayerView_Previews: PreviewProvider {
    ...
    private final class ActionsForPreviews: TransfertProtocolSourceCodeDisplayerViewActionsProtocol {
        ...
        func userWantsToInitiateOwnedIdentityTransferProtocolOnSourceDevice(ownedCryptoId: ObvTypes.ObvCryptoId, onAvailableSessionNumber: @escaping (ObvOwnedIdentityTransferSessionNumber) -> Void, onAvailableSASExpectedOnInput: @escaping (ObvOwnedIdentityTransferSas, String, UID) -> Void) async throws {
         
            Task {
                try! await Task.sleep(seconds: 0)
                onAvailableSessionNumber(try! ObvOwnedIdentityTransferSessionNumber(sessionNumber: 112233))
            }
