...
fileprivate class ProfilePictureBarButtonItem: UIBarButtonItem {
    ...
    static func makeWithInitialConfiguration(_ initialConfiguration: CircledInitialsConfiguration) -> ProfilePictureBarButtonItem {
        ...
        buttonView.addSubview(profilePictureView)
        ...
        NSLayoutConstraint.activate([
            profilePictureView.centerXAnchor.constraint(equalTo: buttonView.centerXAnchor),
            profilePictureView.centerYAnchor.constraint(equalTo: buttonView.centerYAnchor),
            profilePictureView.heightAnchor.constraint(equalTo: buttonView.heightAnchor, multiplier: 0.8),
