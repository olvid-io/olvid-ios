...
class InitializationFailureViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            self.shareErrorMessageExplanationLabel.text = Strings.shareErrorMessageExplanationWhenNoMail(ObvMessengerConstants.toEmailForSendingInitializationFailureErrorMessage)
        }
        if !MFMailComposeViewController.canSendMail() {
