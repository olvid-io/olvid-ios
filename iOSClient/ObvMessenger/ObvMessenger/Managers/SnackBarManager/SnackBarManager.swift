...
final class SnackBarManager {
    ...
    private let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: String(describing: SnackBarManager.self))
    ...
    private func determineSnackBarToDisplay() {
        ...
        ObvStack.shared.performBackgroundTaskAndWait { context in
            ...
            do {
                ...
                os_log("SnackBarManager error: %{public}@", log: log, type: .fault, error.localizedDescription)
                assertionFailure()
                return
            }
