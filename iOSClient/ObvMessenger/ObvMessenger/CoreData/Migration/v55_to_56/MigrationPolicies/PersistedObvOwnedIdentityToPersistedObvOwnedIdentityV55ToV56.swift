...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedObvOwnedIdentityToPersistedObvOwnedIdentityV55ToV56]"

// Ok
final class PersistedObvOwnedIdentityToPersistedObvOwnedIdentityV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedObvOwnedIdentityToPersistedObvOwnedIdentityV55ToV56")
