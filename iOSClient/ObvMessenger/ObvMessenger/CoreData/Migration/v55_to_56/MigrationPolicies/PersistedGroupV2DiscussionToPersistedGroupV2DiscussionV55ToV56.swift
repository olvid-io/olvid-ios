...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedGroupV2DiscussionToPersistedGroupV2DiscussionV55ToV56]"

// Ok
final class PersistedGroupV2DiscussionToPersistedGroupV2DiscussionV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedGroupV2DiscussionToPersistedGroupV2DiscussionV55ToV56")
