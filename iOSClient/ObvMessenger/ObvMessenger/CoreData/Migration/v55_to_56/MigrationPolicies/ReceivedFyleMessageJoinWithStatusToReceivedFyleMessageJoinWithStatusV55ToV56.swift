...
fileprivate let debugPrintPrefix = "[\(errorDomain)][ReceivedFyleMessageJoinWithStatusToReceivedFyleMessageJoinWithStatusV55ToV56]"

// Ok
final class ReceivedFyleMessageJoinWithStatusToReceivedFyleMessageJoinWithStatusV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "ReceivedFyleMessageJoinWithStatusToReceivedFyleMessageJoinWithStatusV55ToV56")
