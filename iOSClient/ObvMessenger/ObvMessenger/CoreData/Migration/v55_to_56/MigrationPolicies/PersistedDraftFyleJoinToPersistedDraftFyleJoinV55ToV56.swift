...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedDraftFyleJoinToPersistedDraftFyleJoinV55ToV56]"

// Ok
final class PersistedDraftFyleJoinToPersistedDraftFyleJoinV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedDraftFyleJoinToPersistedDraftFyleJoinV55ToV56")
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        do {
            let entityName = "PersistedDraftFyleJoin"
