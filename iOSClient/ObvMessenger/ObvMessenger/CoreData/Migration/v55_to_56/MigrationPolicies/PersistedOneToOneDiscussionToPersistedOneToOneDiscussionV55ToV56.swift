...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedOneToOneDiscussionToPersistedOneToOneDiscussionV55ToV56]"

// Ok
final class PersistedOneToOneDiscussionToPersistedOneToOneDiscussionV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedOneToOneDiscussionToPersistedOneToOneDiscussionV55ToV56")
