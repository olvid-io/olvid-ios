...
fileprivate let debugPrintPrefix = "[\(errorDomain)][DisplayedContactGroupToDisplayedContactGroupV55ToV56]"

// Ok
final class DisplayedContactGroupToDisplayedContactGroupV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "DisplayedContactGroupToDisplayedContactGroupV55ToV56")
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        do {
            let entityName = "DisplayedContactGroup"
