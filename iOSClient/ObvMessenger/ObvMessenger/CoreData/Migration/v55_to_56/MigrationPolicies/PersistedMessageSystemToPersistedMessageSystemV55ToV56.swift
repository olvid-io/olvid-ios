...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedMessageSystemToPersistedMessageSystemV55ToV56]"

// Ok
final class PersistedMessageSystemToPersistedMessageSystemV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedMessageSystemToPersistedMessageSystemV55ToV56")
