...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedMessageReceivedToPersistedMessageReceivedV55ToV56]"

// Ok
final class PersistedMessageReceivedToPersistedMessageReceivedV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedMessageReceivedToPersistedMessageReceivedV55ToV56")
