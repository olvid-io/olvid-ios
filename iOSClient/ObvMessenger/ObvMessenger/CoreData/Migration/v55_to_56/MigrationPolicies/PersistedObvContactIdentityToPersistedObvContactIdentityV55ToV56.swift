...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedObvContactIdentityToPersistedObvContactIdentityV55ToV56]"

// Ok
final class PersistedObvContactIdentityToPersistedObvContactIdentityV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedObvContactIdentityToPersistedObvContactIdentityV55ToV56")
