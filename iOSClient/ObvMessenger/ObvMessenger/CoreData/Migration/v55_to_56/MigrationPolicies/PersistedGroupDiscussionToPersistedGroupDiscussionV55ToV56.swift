...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedGroupDiscussionToPersistedGroupDiscussionV55ToV56]"

// Ok
final class PersistedGroupDiscussionToPersistedGroupDiscussionV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedGroupDiscussionToPersistedGroupDiscussionV55ToV56")
