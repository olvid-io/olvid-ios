...
fileprivate let debugPrintPrefix = "[\(errorDomain)][SentFyleMessageJoinWithStatusToSentFyleMessageJoinWithStatusV55ToV56]"

// Ok
final class SentFyleMessageJoinWithStatusToSentFyleMessageJoinWithStatusV55ToV56: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "SentFyleMessageJoinWithStatusToSentFyleMessageJoinWithStatusV55ToV56")
