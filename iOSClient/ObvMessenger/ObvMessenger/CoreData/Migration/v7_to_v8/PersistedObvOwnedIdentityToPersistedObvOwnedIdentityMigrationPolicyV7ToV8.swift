...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedObvOwnedIdentityToPersistedObvOwnedIdentityMigrationPolicyV7ToV8]"


final class PersistedObvOwnedIdentityToPersistedObvOwnedIdentityMigrationPolicyV7ToV8: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let dPersistedObvOwnedIdentity: NSManagedObject
        do {
            let entityName = "PersistedObvOwnedIdentity"
            ...
            dPersistedObvOwnedIdentity = NSManagedObject(entity: description, insertInto: manager.destinationContext)
        }
        ...
        try traversePropertyMappings { (propertyMapping, destinationName) in
            if let valueExpression = propertyMapping.valueExpression {
                ...
                dPersistedObvOwnedIdentity.setValue(destinationValue, forKey: destinationName)
            }
        }
        ...
        dPersistedObvOwnedIdentity.setValue(dSerializedIdentityCoreDetails, forKey: "serializedIdentityCoreDetails")
        dPersistedObvOwnedIdentity.setValue(dObvIdentityCoreDetails.getDisplayNameWithStyle(ObvDisplayNameStyleForMigrationV7ToV8.full), forKey: "fullDisplayName")
        ...
        manager.associate(sourceInstance: sInstance, withDestinationInstance: dPersistedObvOwnedIdentity, for: mapping)
