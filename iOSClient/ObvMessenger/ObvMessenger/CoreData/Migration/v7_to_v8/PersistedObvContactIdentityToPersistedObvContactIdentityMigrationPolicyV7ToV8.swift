...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedObvContactIdentityToPersistedObvContactIdentityMigrationPolicyV7ToV8]"


final class PersistedObvContactIdentityToPersistedObvContactIdentityMigrationPolicyV7ToV8: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        dPersistedObvContactIdentity.setValue(dSerializedIdentityCoreDetails, forKey: "serializedIdentityCoreDetails")
        dPersistedObvContactIdentity.setValue(dObvIdentityCoreDetails.getDisplayNameWithStyle(ObvDisplayNameStyleForMigrationV7ToV8.full), forKey: "fullDisplayName")
        dPersistedObvContactIdentity.setValue(false, forKey: "newPublishedDetails")
