...
final class PersistedDiscussionSharedConfigurationToPersistedDiscussionSharedConfigurationV54ToV55: NSEntityMigrationPolicy {
    ...
    let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PersistedDiscussionSharedConfigurationToPersistedDiscussionSharedConfigurationV54ToV55")
