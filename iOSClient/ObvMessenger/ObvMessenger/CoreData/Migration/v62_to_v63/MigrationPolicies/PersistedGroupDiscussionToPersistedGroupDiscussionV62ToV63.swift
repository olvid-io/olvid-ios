...
final class PersistedGroupDiscussionToPersistedGroupDiscussionV62ToV63: NSEntityMigrationPolicy, ObvErrorMaker {
    
    static let errorDomain = "MessengerMigrationV62ToV63"
    static let debugPrintPrefix = "[\(errorDomain)][PersistedGroupDiscussionToPersistedGroupDiscussionV62ToV63]"
