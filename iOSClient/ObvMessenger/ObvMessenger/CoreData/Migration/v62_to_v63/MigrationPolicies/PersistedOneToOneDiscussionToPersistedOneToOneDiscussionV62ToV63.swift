...
final class PersistedOneToOneDiscussionToPersistedOneToOneDiscussionV62ToV63: NSEntityMigrationPolicy, ObvErrorMaker {
    
    static let errorDomain = "MessengerMigrationV62ToV63"
    static let debugPrintPrefix = "[\(errorDomain)][PersistedOneToOneDiscussionToPersistedOneToOneDiscussionV62ToV63]"
