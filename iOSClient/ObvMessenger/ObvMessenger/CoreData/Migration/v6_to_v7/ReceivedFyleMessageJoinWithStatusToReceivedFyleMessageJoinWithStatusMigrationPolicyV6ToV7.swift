...
final class ReceivedFyleMessageJoinWithStatusToReceivedFyleMessageJoinWithStatusMigrationPolicyV6ToV7: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let newReceivedFyleMessageJoinWithStatus = ReceivedFyleMessageJoinWithStatus(entity: description, insertInto: manager.destinationContext)
        ...
        try traversePropertyMappings { (propertyMapping, destinationName) in
            if let valueExpression = propertyMapping.valueExpression {
                ...
                newReceivedFyleMessageJoinWithStatus.setValue(destinationValue, forKey: destinationName)
            }
        }
        ...
        newReceivedFyleMessageJoinWithStatus.setValue(uti, forKey: "uti")
        ...
        manager.associate(sourceInstance: sInstance, withDestinationInstance: newReceivedFyleMessageJoinWithStatus, for: mapping)
