...
final class PersistedGroupDiscussionToPersistedGroupDiscussionMigrationPolicyV6ToV7: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let newPersistedGroupDiscussion: PersistedGroupDiscussion
        do {
            ...
            newPersistedGroupDiscussion = PersistedGroupDiscussion(entity: description, insertInto: manager.destinationContext)
        }
        ...
        try traversePropertyMappings { (propertyMapping, destinationName) in
            if let valueExpression = propertyMapping.valueExpression {
                ...
                newPersistedGroupDiscussion.setValue(destinationValue, forKey: destinationName)
            }
        }
        
        // For each PersistedGroupDiscussion we want to create a new PersistedDraft (we discard the previous Draft within this migration)
        ...
        do {
            ...
            persistedDraft.setValue(newPersistedGroupDiscussion, forKey: "discussion")
        }
        ...
        manager.associate(sourceInstance: sInstance, withDestinationInstance: newPersistedGroupDiscussion, for: mapping)
