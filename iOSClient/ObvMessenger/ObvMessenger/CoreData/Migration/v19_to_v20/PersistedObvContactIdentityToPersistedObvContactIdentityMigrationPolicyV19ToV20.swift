...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedObvContactIdentityToPersistedObvContactIdentityMigrationPolicyV19ToV20]"

final class PersistedObvContactIdentityToPersistedObvContactIdentityMigrationPolicyV19ToV20: NSEntityMigrationPolicy {
...
fileprivate struct PersistedObvContactIdentityConstraints: Hashable {
