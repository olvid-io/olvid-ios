...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedMessageSentToPersistedMessageSentMigrationPolicyV9ToV10]"


final class PersistedMessageSentToPersistedMessageSentMigrationPolicyV9ToV10: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let dPersistedMessageSent = try initializeDestinationInstance(forEntityName: entityName,
                                                                      forSource: sInstance,
                                                                      in: mapping,
                                                                      manager: manager,
        ...
        dPersistedMessageSent.setValue(dSectionIdentifier, forKey: "sectionIdentifier")
        ...
        manager.associate(sourceInstance: sInstance, withDestinationInstance: dPersistedMessageSent, for: mapping)
