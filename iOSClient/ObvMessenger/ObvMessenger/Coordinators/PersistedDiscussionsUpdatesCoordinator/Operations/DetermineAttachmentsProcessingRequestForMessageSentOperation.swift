...
final class DetermineAttachmentsProcessingRequestForMessageSentOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel> {
    
    // MARK: attributes - private
    private let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "DetermineAttachmentsProcessingRequestForMessageSentOperation")
