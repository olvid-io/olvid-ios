...
///
final class TryToAutoReadDiscussionsReceivedMessagesThatRequireUserActionOperation: ContextualOperationWithSpecificReasonForCancel<TryToAutoReadDiscussionsReceivedMessagesThatRequireUserActionOperation.ReasonForCancel>, OperationProvidingLimitedVisibilityMessageOpenedJSONs {
        
    private let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: String(describing: TryToAutoReadDiscussionsReceivedMessagesThatRequireUserActionOperation.self))
