...
final class SaveBodyTextAndMentionsOfPersistedDraftOperation: ContextualOperationWithSpecificReasonForCancel<SaveBodyTextOfPersistedDraftOperationReasonForCancel> {
