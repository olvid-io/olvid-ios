...
final class ProcessDetectionThatSensitiveMessagesWereCapturedOperation: ContextualOperationWithSpecificReasonForCancel<ProcessDetectionThatSensitiveMessagesWereCapturedOperation.ReasonForCancel> {
