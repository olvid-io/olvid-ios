...
final class ProcessSetOrUpdateReactionOnMessageOperation: ContextualOperationWithSpecificReasonForCancel<ProcessSetOrUpdateReactionOnMessageOperation.ReasonForCancel> {
    ...
    override func main(obvContext: ObvContext, viewContext: NSManagedObjectContext) {
        ...
        do {
            ...
            case .contact(contactIdentifier: let contactIdentifier):
                ...
                updatedMessage = try contact.processSetOrUpdateReactionOnMessageRequestFromThisContact(reactionJSON: reactionJSON, messageUploadTimestampFromServer: messageUploadTimestampFromServer)
