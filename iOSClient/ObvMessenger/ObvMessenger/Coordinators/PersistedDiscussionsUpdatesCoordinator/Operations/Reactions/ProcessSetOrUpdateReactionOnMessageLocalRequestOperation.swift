...
final class ProcessSetOrUpdateReactionOnMessageLocalRequestOperation: ContextualOperationWithSpecificReasonForCancel<ProcessSetOrUpdateReactionOnMessageLocalRequestOperation.ReasonForCancel> {
