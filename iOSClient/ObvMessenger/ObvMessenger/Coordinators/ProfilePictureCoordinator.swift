...
final class ProfilePictureCoordinator {
    
    private let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: String(describing: ProfilePictureCoordinator.self))
