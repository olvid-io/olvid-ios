...
final class SendDataThroughPeerConnectionOperation: AsyncOperationWithSpecificReasonForCancel<SendDataThroughPeerConnectionOperation.ReasonForCancel> {
    
    private static let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "SendDataThroughPeerConnectionOperation")
