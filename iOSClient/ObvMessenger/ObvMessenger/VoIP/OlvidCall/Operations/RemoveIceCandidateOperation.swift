...
final class RemoveIceCandidatesOperation: AsyncOperationWithSpecificReasonForCancel<RemoveIceCandidatesOperation.ReasonForCancel> {

    private static let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "RemoveIceCandidatesOperation")
