...
final class ConfigureAudioSessionOperation: OperationWithSpecificReasonForCancel<ConfigureAudioSessionOperation.ReasonForCancel> {

    private static let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "ConfigureAudioSessionOperation")
