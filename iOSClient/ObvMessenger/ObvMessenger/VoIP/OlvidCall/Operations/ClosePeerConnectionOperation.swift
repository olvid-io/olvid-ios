...
final class ClosePeerConnectionOperation: AsyncOperationWithSpecificReasonForCancel<ClosePeerConnectionOperation.ReasonForCancel> {

    private static let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "ClosePeerConnectionOperation")
