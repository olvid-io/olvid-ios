...
actor PushKitNotificationSynchronizer {
    ...
    private static let log = OSLog(subsystem: ObvMessengerConstants.logSubsystem, category: "PushKitNotificationSynchronizer")

    private var receivedStartCallMessageForCallWithCallIdentifierForCallKit = [UUID: (callerId: ObvContactIdentifier, startCallMessage: StartCallMessageJSON, uuidForWebRTC: UUID)]()
    ...
    func waitForStartCallMessage(encryptedNotification: ObvEncryptedPushNotification) async throws -> (callerId: ObvContactIdentifier, startCallMessage: StartCallMessageJSON, uuidForWebRTC: UUID) {
    ...
    func continuePushKitNotificationProcessing(_ startCallMessage: StartCallMessageJSON, messageIdFromServer: UID, callerId: ObvContactIdentifier, uuidForWebRTC: UUID) {
        ...
        receivedStartCallMessageForCallWithCallIdentifierForCallKit[callIdentifierForCallKit] = (callerId, startCallMessage, uuidForWebRTC)
