...
public final class ObvContext: Hashable {
    ...
    public init(context: NSManagedObjectContext, flowId: FlowIdentifier, file: StaticString, line: Int, function: StaticString) {
        ...
        self.flowId = flowId
        self.token = NotificationCenter.default.addObserver(forName: Notification.Name.NSManagedObjectContextDidSave, object: nil, queue: nil) { [weak self] (notification) in
