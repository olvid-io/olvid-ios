...
final class ObvNetworkSendDelegateManager: @unchecked Sendable {
    ...
    let queueSharedAmongCoordinators = OperationQueue.createSerialQueue(name: "Queue shared among coordinators of ObvNetworkSendManagerImplementation", qualityOfService: qualityOfService)
