...
final class GetSignedURLsSessionDelegate: NSObject {
    ...
    init(attachmentId: ObvAttachmentIdentifier, obvContext: ObvContext, appType: AppType, logSubsystem: String, attachmentChunksSignedURLsTracker: AttachmentChunksSignedURLsTracker) {
