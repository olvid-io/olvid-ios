...
final class DecryptAndSaveExtendedMessagePayloadOperation: ContextualOperationWithSpecificReasonForCancel<DecryptAndSaveExtendedMessagePayloadOperation.ReasonForCancel>, @unchecked Sendable {
    
    private let messageId: ObvMessageIdentifier
    private let encryptedExtendedMessagePayload: EncryptedData
    private let inbox: URL
    
    init(messageId: ObvMessageIdentifier, encryptedExtendedMessagePayload: EncryptedData, inbox: URL) {
    ...
    override func main(obvContext: ObvContext, viewContext: NSManagedObjectContext) {
        ...
        do {
            ...
            obvMessageOrObvOwnedMessage = message.getObvMessageOrObvOwnedMessage(inbox: inbox)
