...
final class MarkChunkAsWrittenToAttachmentFileOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel>, @unchecked Sendable {

    private let attachmentId: ObvAttachmentIdentifier
    private let chunkNumber: Int

    init(attachmentId: ObvAttachmentIdentifier, chunkNumber: Int) {
    ...
    override func main(obvContext: ObvContext, viewContext: NSManagedObjectContext) {
        ...
        do {
            ...
            self.attachmentIsDownloaded = attachment.isDownloaded
