...
final class ResumeOrSuspendAllTasksOfURLSessionOperation: Operation, @unchecked Sendable {
    ...
    private let logCategory = String(describing: ResumeOrSuspendAllTasksOfURLSessionOperation.self)
