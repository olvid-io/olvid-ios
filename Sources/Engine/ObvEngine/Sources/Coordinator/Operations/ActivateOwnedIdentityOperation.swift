...
final class ActivateOwnedIdentityOperation: ContextualOperationWithSpecificReasonForCancel<ActivateOwnedIdentityOperation.ReasonForCancel>, @unchecked Sendable {
