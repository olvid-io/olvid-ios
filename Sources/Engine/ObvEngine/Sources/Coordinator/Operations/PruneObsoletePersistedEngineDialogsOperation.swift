...
final class PruneObsoletePersistedEngineDialogsOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel>, @unchecked Sendable {
    
    private let appNotificationCenter: NotificationCenter
    
    init(appNotificationCenter: NotificationCenter) {
