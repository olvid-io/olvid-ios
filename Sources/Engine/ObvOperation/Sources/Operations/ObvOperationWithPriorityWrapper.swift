...
open class ObvOperationWithPriorityWrapper<WrappedObvOperationType: ObvOperationWithPriority>: ObvOperationWithPriority, OperationDelegate, @unchecked Sendable {
