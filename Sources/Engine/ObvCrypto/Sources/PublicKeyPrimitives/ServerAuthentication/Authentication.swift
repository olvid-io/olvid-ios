...
public protocol AuthenticationCommon {
    static func solve(_: Data, prefixedWith: Data, with: PrivateKeyForAuthentication, and: PublicKeyForAuthentication, using: PRNG) throws -> Data?
    static func solve(_: Data, prefixedWith: Data, with: PrivateKeyForAuthentication, using: PRNG) throws -> Data?
...
public protocol AuthenticationConcrete: AuthenticationCommon {
    ...
    static func generateKeyPair(with: PRNG) -> (PublicKeyForAuthentication, PrivateKeyForAuthentication)
}

protocol AuthenticationGeneric: AuthenticationCommon {
    static func generateKeyPair(for: AuthenticationImplementationByteId, with: PRNG) -> (PublicKeyForAuthentication, PrivateKeyForAuthentication)
    static func solve(_: Data, prefixedWith: Data, for: ObvOwnedCryptoIdentity, using: PRNG) throws -> Data?
...
public final class Authentication: AuthenticationGeneric {
    ...
    public static func generateKeyPair(for implemByteId: AuthenticationImplementationByteId, with prng: PRNG) -> (PublicKeyForAuthentication, PrivateKeyForAuthentication) {
        return implemByteId.algorithmImplementation.generateKeyPair(with: prng)
    }
    
    public static func solve(_ challenge: Data, prefixedWith prefix: Data, with privateKey: PrivateKeyForAuthentication, and publicKey: PublicKeyForAuthentication, using prng: PRNG) throws -> Data? {
    ...
    public static func solve(_ challenge: Data, prefixedWith prefix: Data, for ownedIdentity: ObvOwnedCryptoIdentity, using prng: PRNG) throws -> Data? {
    ...
    public static func solve(_ challenge: Data, prefixedWith prefix: Data, with privateKey: PrivateKeyForAuthentication, using prng: PRNG) throws -> Data? {
        let algorithmImplementation = privateKey.algorithmImplementationByteId.algorithmImplementation
...
extension AuthenticationFromSignatureOnEdwardsCurve {
    ...
    static func generateKeyPair(with prng: PRNG) -> (PublicKeyForAuthentication, PrivateKeyForAuthentication) {
    ...
    static func solve(_ challenge: Data, prefixedWith prefix: Data, with _privateKey: PrivateKeyForAuthentication, and _publicKey: PublicKeyForAuthentication, using prng: PRNG) -> Data? {
    ...
    static func solve(_ challenge: Data, prefixedWith prefix: Data, with _privateKey: PrivateKeyForAuthentication, using prng: PRNG) throws -> Data? {
