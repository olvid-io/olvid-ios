...
final class PendingServerQueryToPendingServerQueryMigrationPolicyV49ToV50: NSEntityMigrationPolicy, ObvErrorMaker {
    
    static let errorDomain = "PendingServerQuery"
    static let debugPrintPrefix = "[\(errorDomain)][PendingServerQueryToPendingServerQueryMigrationPolicyV49ToV50]"
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        do {
            ...
            // Move the old `ownedIdentity` to the new `rawOwnedIdentity` attribute.
            ...
            guard let cryptoIdentity = sInstance.value(forKey: "ownedIdentity") as? ObvCryptoIdentity else {
                throw ObvError.couldNotGetCryptoIdentity
            }

            dInstance.setValue(cryptoIdentity.getIdentity(), forKey: "rawOwnedIdentity")
