...
// ok
final class ContactDeviceToContactDeviceV61ToV62: NSEntityMigrationPolicy {
    
    static let entityName: String = "ContactDevice"
    static let errorDomain: String = entityName
    static let debugPrintPrefix: String = "[\(errorDomain)][ContactDeviceToContactDeviceV61ToV62]"
