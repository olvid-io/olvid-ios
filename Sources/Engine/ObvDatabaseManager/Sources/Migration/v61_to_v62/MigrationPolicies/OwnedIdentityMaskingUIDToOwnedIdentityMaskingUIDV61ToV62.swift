...
// ok
final class OwnedIdentityMaskingUIDToOwnedIdentityMaskingUIDV61ToV62: NSEntityMigrationPolicy {
    
    static let entityName: String = "OwnedIdentityMaskingUID"
    static let errorDomain: String = entityName
    static let debugPrintPrefix: String = "[\(errorDomain)][OwnedIdentityMaskingUIDToOwnedIdentityMaskingUIDV61ToV62]"
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        do {
            ...
            do {
                ...
                guard let maskingUID = sInstance.value(forKey: "maskingUID") as? UID else {
                    assertionFailure()
                    throw ObvError.couldNotGetMaskingUID
                }
                
                dInstance.setValue(maskingUID.raw, forKey: "rawMaskingUID")
            ...
            do {
                _ = try getMaskingUID(dInstance: dInstance)
            }
    ...
    private func getMaskingUID(dInstance: NSManagedObject) throws(ObvErrorForChecks) -> UID {
        guard let rawMaskingUID = dInstance.value(forKey: "rawMaskingUID") as? Data else { assertionFailure(); throw .unexpectedNilValue }
