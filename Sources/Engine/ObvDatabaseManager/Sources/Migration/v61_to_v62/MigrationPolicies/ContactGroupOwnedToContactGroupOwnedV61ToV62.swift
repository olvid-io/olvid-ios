...
// ok
final class ContactGroupOwnedToContactGroupOwnedV61ToV62: NSEntityMigrationPolicy {
    
    static let entityName: String = "ContactGroupOwned"
    static let errorDomain: String = entityName
    static let debugPrintPrefix: String = "[\(errorDomain)][ContactGroupOwnedToContactGroupOwnedV61ToV62]"
