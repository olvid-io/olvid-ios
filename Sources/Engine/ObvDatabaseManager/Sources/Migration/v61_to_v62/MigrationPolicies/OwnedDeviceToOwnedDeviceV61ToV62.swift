...
// ok
final class OwnedDeviceToOwnedDeviceV61ToV62: NSEntityMigrationPolicy {
    
    static let entityName: String = "OwnedDevice"
    static let errorDomain: String = entityName
    static let debugPrintPrefix: String = "[\(errorDomain)][OwnedDeviceToOwnedDeviceV61ToV62]"
