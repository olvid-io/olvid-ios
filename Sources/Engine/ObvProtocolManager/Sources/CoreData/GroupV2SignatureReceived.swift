...
final class GroupV2SignatureReceived: NSManagedObject {
    ...
    convenience init?(ownedCryptoIdentity: ObvCryptoIdentity, signature: Data, within context: NSManagedObjectContext) {
        ...
        let entityDescription = NSEntityDescription.entity(forEntityName: GroupV2SignatureReceived.entityName, in: context)!
