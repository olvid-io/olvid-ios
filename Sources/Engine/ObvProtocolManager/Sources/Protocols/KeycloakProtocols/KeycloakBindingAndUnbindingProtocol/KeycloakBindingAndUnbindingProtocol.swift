...
public struct KeycloakBindingAndUnbindingProtocol: ConcreteCryptoProtocol {

    static let logCategory = "KeycloakBindingAndUnbindingProtocol"

    static let id = CryptoProtocolId.keycloakBindingAndUnbinding

    private static let errorDomain = "KeycloakBindingAndUnbindingProtocol"
