...
public struct ContactDeviceDiscoveryProtocol: ConcreteCryptoProtocol {
    
    static let logCategory = "ContactDeviceDiscoveryProtocol"
    
    static let id = CryptoProtocolId.contactDeviceDiscovery
