...
public struct DownloadGroupV2PhotoProtocol: ConcreteCryptoProtocol {
    
    static let logCategory = "DownloadGroupV2PhotoProtocol"
    
    static let id = CryptoProtocolId.downloadGroupV2Photo
