...
public final class ObvServerCreateBackupMethod: ObvServerDataMethod {
    
    public let pathComponent = "/backupCreate"

    public let serverURL: URL
    private let backupKeyUID: UID
    private let authenticationPublicKey: any PublicKeyForAuthentication
    ...
    public init(serverURL: URL, backupKeyUID: UID, authenticationPublicKey: any PublicKeyForAuthentication, flowId: FlowIdentifier) {
    ...
    public enum PossibleReturnStatus: UInt8 {
        case ok = 0x00
        case backupUIDAlreadyUsed = 0x19
    ...
    public var dataToSendNonNil: Data {
        let encoded = [
            ...
            authenticationPublicKey.obvEncode(),
        ].obvEncode()
