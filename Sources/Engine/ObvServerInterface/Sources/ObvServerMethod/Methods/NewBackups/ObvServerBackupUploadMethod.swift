...
public final class ObvServerBackupUploadMethod: ObvServerDataMethod {
    
    public let pathComponent = "/backupUpload"

    public let serverURL: URL
    private let backupKeyUID: UID
    private let threadUID: UID
    private let backupVersion: Int
    private let encryptedBackup: EncryptedData
    ...
    public init(serverURL: URL, backupKeyUID: UID, threadUID: UID, backupVersion: Int, encryptedBackup: EncryptedData, signature: Data, flowId: FlowIdentifier) {
    ...
    public enum PossibleReturnStatus: UInt8 {
        ...
        case backupVersionTooSmall = 0x1a
