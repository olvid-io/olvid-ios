...
final class LoadFileRepresentationsOperation: Operation, @unchecked Sendable, LoadedItemProviderProvider {
    ...
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: "LoadFileRepresentationsOperation")
