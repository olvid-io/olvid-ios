...
class PendingGroupMembersTableViewController: UITableViewController {
    ...
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: PendingGroupMembersTableViewController.self))
...
extension PendingGroupMembersTableViewController {
    ...
    private func configure(_ cell: ObvTitleTableViewCell, withObjectAtIndexPath indexPath: IndexPath) {
        guard let pendingMember = fetchedResultsController.safeObject(at: indexPath) else { return }
        configure(cell, with: pendingMember)
    }
...
extension PendingGroupMembersTableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        guard let persistedPendingGroupMember = fetchedResultsController.safeObject(at: indexPath) else { return }
