...
actor LatestCurrentOwnedIdentityStorage {
    ...
    func getLatestCurrentOwnedIdentityStored() -> LatestCurrentOWnedIdentityStored? {
        guard let sharedUserDefaults = UserDefaults(suiteName: ObvAppCoreConstants.appGroupIdentifier) else { assertionFailure(); return nil }
    ...
    func removeLatestCurrentOWnedIdentityStored() {
        guard let sharedUserDefaults = UserDefaults(suiteName: ObvAppCoreConstants.appGroupIdentifier) else { assertionFailure(); return }
