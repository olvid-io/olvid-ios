...
extension OlvidCallParticipant: OlvidCallParticipantViewModelProtocol {
    ...
    var circledInitialsConfiguration: ObvUIObvCircledInitials.CircledInitialsConfiguration {
        ...
        do {
            ...
            case .known(contactObjectID: let contactObjectID, contactIdentifier: _, contactDeviceUID: _):
    ...
    private var defaultCircledInitialsConfiguration: ObvUIObvCircledInitials.CircledInitialsConfiguration {
