...
struct OlvidCallView_Previews: PreviewProvider {
    ...
    private final class CallParticipantModelForPreviews: OlvidCallParticipantViewModelProtocol {
        ...
        init(cryptoId: ObvTypes.ObvCryptoId, showRemoveParticipantButton: Bool, displayName: String, stateLocalizedDescription: String, circledInitialsConfiguration: ObvUIObvCircledInitials.CircledInitialsConfiguration, contactIsMuted: Bool, isOneToOne: Bool) {
    ...
    private final class OwnedCircleViewModelForPreviews: InitialCircleViewNewModelProtocol {
        var circledInitialsConfiguration: ObvUIObvCircledInitials.CircledInitialsConfiguration {
            return .icon(.person)
        }
    }
