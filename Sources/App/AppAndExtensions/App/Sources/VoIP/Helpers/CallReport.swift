...
enum CallReport {
    case missedIncomingCall(caller: OlvidCallParticipantInfo?, initialOtherParticipantsCount: Int)
    case filteredIncomingCall(caller: OlvidCallParticipantInfo?, initialOtherParticipantsCount: Int)
...
extension CallReport: CustomStringConvertible {
    ...
    var participantInfos: [OlvidCallParticipantInfo?] {
        switch self {
        case .missedIncomingCall(caller: let caller, initialOtherParticipantsCount: _):
            return [caller]
        case .filteredIncomingCall(caller: let caller, initialOtherParticipantsCount: _):
            return [caller]
