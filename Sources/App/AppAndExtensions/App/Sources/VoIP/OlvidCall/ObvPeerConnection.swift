...
final class ObvPeerConnection: NSObject, @unchecked Sendable {


    private static let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: ObvPeerConnection.self))
...
protocol ObvDataChannelDelegate: AnyObject, Sendable {
