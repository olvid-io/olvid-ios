...
final class SetRemoteDescriptionOperation: AsyncOperationWithSpecificReasonForCancel<SetRemoteDescriptionOperation.ReasonForCancel>, @unchecked Sendable {

    private static let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: "SetRemoteDescriptionOperation")
