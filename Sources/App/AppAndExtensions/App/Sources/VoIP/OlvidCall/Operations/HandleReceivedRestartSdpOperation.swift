...
final class HandleReceivedRestartSdpOperation: AsyncOperationWithSpecificReasonForCancel<HandleReceivedRestartSdpOperation.ReasonForCancel>, @unchecked Sendable {
