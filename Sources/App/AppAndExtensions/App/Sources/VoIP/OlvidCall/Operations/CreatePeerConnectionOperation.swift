...
final class CreatePeerConnectionOperation: AsyncOperationWithSpecificReasonForCancel<CreatePeerConnectionOperation.ReasonForCancel>, @unchecked Sendable {

    private static let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: "CreatePeerConnectionOperation")
