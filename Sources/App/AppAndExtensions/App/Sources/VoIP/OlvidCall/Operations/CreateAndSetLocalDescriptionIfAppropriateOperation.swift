...
final class CreateAndSetLocalDescriptionIfAppropriateOperation: AsyncOperationWithSpecificReasonForCancel<CreateAndSetLocalDescriptionIfAppropriateOperation.ReasonForCancel>, @unchecked Sendable {

    private static let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: "CreateAndSetLocalDescriptionIfAppropriateOperation")
