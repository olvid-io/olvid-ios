...
extension OlvidCoordinator {
    ...
    func queueAndAwaitCompositionOfOneContextualOperation<T: LocalizedErrorWithLogType>(op1: ContextualOperationWithSpecificReasonForCancel<T>, queuePriority: Operation.QueuePriority = .normal) async {
        let composedOp = createCompositionOfOneContextualOperation(op1: op1)
