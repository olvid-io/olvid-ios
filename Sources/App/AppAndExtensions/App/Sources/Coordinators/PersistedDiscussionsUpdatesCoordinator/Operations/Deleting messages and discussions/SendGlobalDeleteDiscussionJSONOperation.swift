...
final class SendGlobalDeleteDiscussionJSONOperation: OperationWithSpecificReasonForCancel<SendGlobalDeleteDiscussionJSONOperationReasonForCancel>, @unchecked Sendable {

    private let persistedDiscussionObjectID: NSManagedObjectID
    private let deletionType: DeletionType
    private let obvEngine: ObvEngine
    
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: SendGlobalDeleteDiscussionJSONOperation.self))
