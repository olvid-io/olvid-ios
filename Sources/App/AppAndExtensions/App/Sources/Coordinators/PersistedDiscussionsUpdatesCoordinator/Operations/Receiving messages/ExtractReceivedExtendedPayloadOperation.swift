...
final class ExtractReceivedExtendedPayloadOperation: OperationWithSpecificReasonForCancel<ExtractReceivedExtendedPayloadOperationReasonForCancel>, @unchecked Sendable {
    ...
    var attachementImages: [ObvAttachmentImage]?
    ...
    override func main() {
        ...
        let result: Result<[ObvAttachmentImage], ExtractReceivedExtendedPayloadOperationReasonForCancel>
    ...
    private func processExtendedPayloadVersion0(listOfEncodedElements: [ObvEncoded]) -> Result<[ObvAttachmentImage], ExtractReceivedExtendedPayloadOperationReasonForCancel> {
    ...
    private func extractDownsizedImagesFromSingleImage(_ singleImage: CGImage, attachmentNumbers: [Int]) -> [ObvAttachmentImage]? {
        ...
        var attachmentImages = [ObvAttachmentImage]()
