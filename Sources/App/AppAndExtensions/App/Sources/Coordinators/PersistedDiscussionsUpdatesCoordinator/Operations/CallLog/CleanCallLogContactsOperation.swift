...
final class CleanCallLogContactsOperation: OperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel>, @unchecked Sendable {

    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: CleanCallLogContactsOperation.self))
