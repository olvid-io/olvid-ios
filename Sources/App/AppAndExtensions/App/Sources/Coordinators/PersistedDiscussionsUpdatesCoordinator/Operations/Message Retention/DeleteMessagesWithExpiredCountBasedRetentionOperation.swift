...
final class DeleteMessagesWithExpiredCountBasedRetentionOperation: OperationWithSpecificReasonForCancel<DeleteMessagesWithExpiredCountBasedRetentionOperationReasonForCancel>, @unchecked Sendable {
    
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: DeleteMessagesWithExpiredCountBasedRetentionOperation.self))
