...
final class InsertPersistedMessageSystemIntoDiscussionOperation: ContextualOperationWithSpecificReasonForCancel<InsertPersistedMessageSystemIntoDiscussionOperationReasonForCancel>, @unchecked Sendable {
    ...
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: InsertPersistedMessageSystemIntoDiscussionOperation.self))
