...
final class ReportCallEventOperation: OperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel>, @unchecked Sendable {

    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: ReportCallEventOperation.self))
    ...
    override func main() {
        ...
        ObvStack.shared.performBackgroundTaskAndWait { context in
            ...
            switch callReport {
            case .missedIncomingCall(_, initialOtherParticipantsCount: let initialOtherParticipantsCount):
                item.initialParticipantCount = initialOtherParticipantsCount
            case .filteredIncomingCall(_, initialOtherParticipantsCount: let initialOtherParticipantsCount):
                item.initialParticipantCount = initialOtherParticipantsCount
