...
final class FindSentMessagesWithPersistedMessageSentRecipientInfosCanNowBeSentByEngineOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel>, @unchecked Sendable {
    
    private static let logger = Logger(subsystem: ObvAppCoreConstants.logSubsystem, category: "FindSentMessagesWithPersistedMessageSentRecipientInfosCanNowBeSentByEngineOperation")
            ...
            for info in unprocessedInfos {
                ...
                do {
                    ...
                    case .oneToOne:
                        ...
                        if let messageSentObjectPermanentID = try? info.messageSent.objectPermanentID {
