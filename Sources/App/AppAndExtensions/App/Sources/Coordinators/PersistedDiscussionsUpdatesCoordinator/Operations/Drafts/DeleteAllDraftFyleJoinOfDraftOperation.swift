...
final class DeleteAllDraftFyleJoinOfDraftOperation: ContextualOperationWithSpecificReasonForCancel<DeleteAllDraftFyleJoinOfDraftOperationReasonForCancel>, @unchecked Sendable {
    ...
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: DeleteAllDraftFyleJoinOfDraftOperation.self))
    ...
    init(draftObjectID: TypeSafeManagedObjectID<PersistedDraft>, draftTypeToDelete: DraftType) {
