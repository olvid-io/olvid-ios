...
final class SendGlobalDeleteMessagesJSONOperation: OperationWithSpecificReasonForCancel<SendGlobalDeleteMessagesJSONOperationReasonForCancel>, @unchecked Sendable {

    private let persistedMessageObjectIDs: [NSManagedObjectID]
    private let deletionType: DeletionType
    private let obvEngine: ObvEngine
    
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: SendGlobalDeleteMessagesJSONOperation.self))
