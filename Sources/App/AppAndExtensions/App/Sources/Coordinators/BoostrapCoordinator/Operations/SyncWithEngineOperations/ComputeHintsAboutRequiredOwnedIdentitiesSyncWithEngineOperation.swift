...
final class ComputeHintsAboutRequiredOwnedIdentitiesSyncWithEngineOperation: AsyncOperationWithSpecificReasonForCancel<ComputeHintsAboutRequiredOwnedIdentitiesSyncWithEngineOperation.ReasonForCancel>, @unchecked Sendable {
    ...
    override func main() async {
        ...
        do {
            ...
            let obvOwnedIdentitiesWithinEngine = try obvEngine.getOwnedIdentities(restrictToActive: false)
