...
final class ComputeHintsAboutRequiredContactGroupsV2SyncWithEngineOperation: AsyncOperationWithSpecificReasonForCancel<ComputeHintsAboutRequiredOwnedDevicesSyncWithEngineOperation.ReasonForCancel>, @unchecked Sendable {
