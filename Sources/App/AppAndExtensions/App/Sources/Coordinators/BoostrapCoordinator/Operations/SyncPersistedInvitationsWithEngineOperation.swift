...
final class SyncPersistedInvitationsWithEngineOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel>, @unchecked Sendable {
    
    let obvDialogsFromEngine: [ObvDialog]
    let obvEngine: ObvEngine
    private let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: String(describing: SyncPersistedInvitationsWithEngineOperation.self))
