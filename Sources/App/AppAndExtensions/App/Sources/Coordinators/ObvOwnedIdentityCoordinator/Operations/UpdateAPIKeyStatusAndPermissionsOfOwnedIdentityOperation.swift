...
final class UpdateAPIKeyStatusAndPermissionsOfOwnedIdentityOperation: ContextualOperationWithSpecificReasonForCancel<CoreDataOperationReasonForCancel>, @unchecked Sendable {
    ...
    override func main(obvContext: ObvContext, viewContext: NSManagedObjectContext) {
        ...
        do {
            guard let persistedObvOwnedIdentity = try PersistedObvOwnedIdentity.get(cryptoId: ownedCryptoId, within: obvContext.context) else {
                // This happens if the owned identity just got deleted
                return
            }
