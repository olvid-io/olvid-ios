...
final class RefreshBadgeForNewMessagesOperation: Operation, @unchecked Sendable {
...
//        }
        ...
        ObvStack.shared.performBackgroundTaskAndWait { [weak self] (context) in
            ...
            let appropriateNewCount = max(0, persistedOwnedIdentity.badgeCountForDiscussionsTab)
            ObvMessengerInternalNotification.badgeForNewMessagesHasBeenUpdated(ownedCryptoId: ownedCryptoId, newCount: appropriateNewCount)
                .postOnDispatchQueue()
