...
final class AboutSettingsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        case .minimumVersionsFromServer:
            ...
            if ObvAppCoreConstants.bundleVersionAsInt < max(ObvMessengerSettings.AppVersionAvailable.latest ?? 0, ObvMessengerSettings.AppVersionAvailable.minimum ?? 0) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .version:
            ...
            case .version:
                ...
                cell.detailTextLabel?.text = ObvAppCoreConstants.fullVersion
