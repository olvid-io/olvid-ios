...
final class BodyEditViewControllerLegacy: UIHostingController<BodyEditViewLegacy>, BodyEditViewStoreDelegate {
    ...
    init(currentBody: String?, dismiss: @escaping () -> Void, send: @escaping (String?) -> Void) {
        ...
        let view = BodyEditViewLegacy(store: store)
...
struct BodyEditViewLegacy: View {
...
private struct BodyEditInnerView: View {
