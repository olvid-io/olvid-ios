...
protocol CellWithMessage: UICollectionViewCell {
    ...
    var activityItemProvidersForAllAttachments: [UIActivityItemProvider]? { get }
    var itemProvidersForAllAttachments: [NSItemProvider]? { get }
    var uiDragItemsForAllAttachments: [UIDragItem]? { get }
    var sizeForUIDragItemPreview: CGSize { get }
    var hardlinkURLsForAllAttachments: [URL]? { get }
...
extension CellWithMessage {
    ...
    var sizeForUIDragItemPreview: CGSize { .init(width: 50, height: 50) }
