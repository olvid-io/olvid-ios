...
struct DateInfosOfSentMessageToManyContactsInnerView: View {
    ...
    var body: some View {
        if !read.isEmpty {
            Section(header: Label("Read", symbolIcon: CustomIcon.checkmarkCircleFill), content: {
        ...
        if !delivered.isEmpty {
            Section(header: Label("Delivered", symbolIcon: CustomIcon.checkmarkCircle), content: {
        ...
        if !sent.isEmpty {
            Section(header: Label("Sent", symbolIcon: CustomIcon.checkmark), content: {
