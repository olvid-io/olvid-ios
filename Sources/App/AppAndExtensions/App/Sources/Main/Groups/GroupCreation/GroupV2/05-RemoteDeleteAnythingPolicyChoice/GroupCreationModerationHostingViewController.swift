...
protocol GroupCreationModerationHostingViewControllerDelegate: AnyObject {
    @MainActor func userWantsToChangeRemoteDeleteAnythingPolicy(in controller: GroupCreationModerationHostingViewController, to policy: ObvUICoreData.PersistedGroupV2.GroupType.RemoteDeleteAnythingPolicy) -> ObvUICoreData.PersistedGroupV2.GroupType.RemoteDeleteAnythingPolicy
}
