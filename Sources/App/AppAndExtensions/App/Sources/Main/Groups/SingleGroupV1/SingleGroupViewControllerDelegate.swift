...
@MainActor
protocol SingleGroupViewControllerDelegate: AnyObject {
    func userWantsToDisplay(_ vc: SingleGroupViewController, persistedDiscussion discussion: PersistedDiscussion)
    func userWantsToDisplay(_ vc: SingleGroupViewController, persistedContact: PersistedObvContactIdentity, within: UINavigationController?)
