...
actor ObvLocationPermissionTask: ObvLocationCancellableTask {
    
    // MARK: - Private Properties
    
    private var tasks = [(taskUUID: UUID, taskType: ObjectIdentifier, task:AnyObvLocationPermissionTask)]()
    private weak var locationManager: ObvLocationPermissionManager?
    
    func setObvLocationPermissionManager(to locationManager: ObvLocationPermissionManager) {
    ...
    func add(task: AnyObvLocationPermissionTask) async {
    ...
    func cancel(task: AnyObvLocationPermissionTask) async {
    ...
    func cancel(tasksTypes type: AnyObvLocationPermissionTask.Type, condition: ((AnyObvLocationPermissionTask) -> Bool)? = nil) {
    ...
    func dispatchEvent(_ event: ObvLocationPermissionManagerEvent) async {
