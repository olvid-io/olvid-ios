...
extension UIImage {
    ...
    @MainActor static func avatarImageForURL(_ url: URL) -> UIImage? {
        ...
        return UIImage(named: String(name), in: ObvDesignSystemResources.bundle, compatibleWith: nil)
    }
...
extension OwnedIdentityChooserViewModel.OwnedIdentity {
    ...
    @MainActor
    static func sampleDataForOwnedCryptoId(_ ownedCryptoId: ObvCryptoId, currentOwnedCryptoId: ObvCryptoId) -> OwnedIdentityChooserViewModel.OwnedIdentity {
...
extension OwnedIdentityChooserViewModel {
    ...
    static var sampleDatas: [Self] = [
        .init(ownedIdentities: ObvCryptoId.sampleDatasForOwnedCryptoId.map({
                  OwnedIdentityChooserViewModel.OwnedIdentity.sampleDataForOwnedCryptoId($0, currentOwnedCryptoId: ObvCryptoId.sampleDatasForOwnedCryptoId[0])
              })),
    ]
