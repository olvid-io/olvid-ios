...
public protocol ObvAudioRecorderDelegate: AnyObject {

    func recordingHasFailed()

}

public final class ObvAudioRecorder: NSObject, AVAudioRecorderDelegate, ObservableObject {
    ...
    public weak var delegate: ObvAudioRecorderDelegate?
    ...
    @Published public var liveWaveformSamples: [Float] = []
    ...
    public enum StartRecordingError: Error {
    ...
    public func startRecording(url: URL, settings: [String: Int],
    ...
    public enum StopRecordingError: Error {
    ...
    public func stopRecording() throws(StopRecordingError) -> URL {
        guard isRecording else {
        ...
        self.liveWaveformSamples.removeAll()
