...
extension NSManagedObjectContext {
    ...
    public func fetchRequestStream<Object: NSManagedObject>(for fetchRequest: NSFetchRequest<Object>) -> FetchRequestStream<Object> {
...
public class FetchRequestStream<Object: NSManagedObject>: NSObject, NSFetchedResultsControllerDelegate {

    private var frc: NSFetchedResultsController<Object>?
    public let stream: AsyncStream<[Object]>
