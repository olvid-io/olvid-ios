...
struct PreviewsHelper {
    ...
    static var profilePictureForURL: [URL: UIImage] = [
        photoURL[0]: UIImage(named: "avatar00", in: ObvUIGroupSharedBetweenV1AndV2Resources.bundle, compatibleWith: nil)!,
        photoURL[1]: UIImage(named: "avatar01", in: ObvUIGroupSharedBetweenV1AndV2Resources.bundle, compatibleWith: nil)!,
        photoURL[2]: UIImage(named: "avatar02", in: ObvUIGroupSharedBetweenV1AndV2Resources.bundle, compatibleWith: nil)!,
    ]
    
    @MainActor
    static var groupPictureForURL: [URL: UIImage] = [
        photoURL[0]: UIImage(named: "group00", in: ObvUIGroupSharedBetweenV1AndV2Resources.bundle, compatibleWith: nil)!,
        photoURL[1]: UIImage(named: "group01", in: ObvUIGroupSharedBetweenV1AndV2Resources.bundle, compatibleWith: nil)!,
        photoURL[2]: UIImage(named: "group02", in: ObvUIGroupSharedBetweenV1AndV2Resources.bundle, compatibleWith: nil)!,
    ]
...
extension SingleGroupMemberView.Model.Identifier {
    ...
    static let sampleIdentifiers: [Self] = [
        .contactIdentifierForCreatingGroupForPreviews(contactIdentifier: PreviewsHelper.contactIdentifiers[0]),
        .contactIdentifierForCreatingGroupForPreviews(contactIdentifier: PreviewsHelper.contactIdentifiers[1]),
        .contactIdentifierForCreatingGroupForPreviews(contactIdentifier: PreviewsHelper.contactIdentifiers[2]),
    ]
...
extension SingleGroupMemberView.Model {
    ...
    @MainActor
    static func sampleDataForIdentifier(_ identifier: SingleGroupMemberView.Model.Identifier) -> Self {
        guard let index = SingleGroupMemberView.Model.Identifier.sampleIdentifiers.firstIndex(of: identifier) else {
            assertionFailure()
            return PreviewsHelper.groupMembers.first!
        }
        return PreviewsHelper.groupMembers[index]
    }
...
extension ObvGroupV2Identifier {
    ...
    static let sampleData: Self = PreviewsHelper.obvGroupV2Identifiers[0]
...
extension ObvGroupIdentifier {
    ...
    static let sampleData: Self = .groupV2(ObvGroupV2Identifier.sampleData)
