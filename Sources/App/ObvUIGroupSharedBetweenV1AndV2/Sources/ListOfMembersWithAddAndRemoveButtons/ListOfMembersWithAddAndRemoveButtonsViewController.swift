...
public final class ListOfMembersWithAddAndRemoveButtonsViewController: UIHostingController<ListOfMembersWithAddAndRemoveButtonsView> {
    
    public let groupIdentifier: ObvGroupIdentifier
    
    public init(groupIdentifier: ObvGroupIdentifier,
                dataSources: ListOfMembersWithAddAndRemoveButtonsView.DataSources,
        ...
        let rootView = ListOfMembersWithAddAndRemoveButtonsView(
