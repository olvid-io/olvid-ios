...
/// This is a legacy type that shall not be used. Prefer ``ObvAppTypes.ObvDiscussionIdentifier`` instead.
...
extension ObvDiscussionIdentifier {
    ...
    public func toDiscussionIdentifier() -> DiscussionIdentifier {
        switch self {
        case .oneToOne(id: let id):
            return .oneToOne(id: .contactCryptoId(contactCryptoId: id.contactCryptoId))
        case .groupV1(id: let id):
            return .groupV1(id: .groupV1Identifier(groupV1Identifier: id.groupV1Identifier))
        case .groupV2(id: let id):
            return .groupV2(id: .groupV2Identifier(groupV2Identifier: id.identifier.appGroupIdentifier))
        }
    }
