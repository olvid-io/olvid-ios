...
public class PersistedInvitation: NSManagedObject {
    ...
    private var inviationUUIDOnDeletion: UUID?
...
extension PersistedInvitation {
    ...
    public func delete() throws {
        ...
        ownedCryptoIdOnDeletion = self.ownedIdentity?.cryptoId
        inviationUUIDOnDeletion = self.uuid
        context.delete(self)
        do {
            try ownedIdentity?.refreshBadgeCountForInvitationsTab()
        } catch {
...
extension PersistedInvitation {
    ...
    public override func didSave() {
        ...
        defer {
            ...
            inviationUUIDOnDeletion = nil
            ownedCryptoIdOnDeletion = nil
        }
