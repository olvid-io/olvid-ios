...
/// ```
public struct ObvManagedObjectPermanentID<T: NSManagedObject>: CustomStringConvertible, Equatable, Hashable, Sendable {
...
public protocol ObvIdentifiableManagedObject: NSManagedObject {
    ...
    var objectPermanentID: ObvManagedObjectPermanentID<Self> { get throws } // Expected to be non-nil, unless the NSManagedObject is deleted
}
