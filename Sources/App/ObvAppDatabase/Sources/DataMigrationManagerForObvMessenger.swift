...
public final class DataMigrationManagerForObvMessenger: DataMigrationManager<ObvMessengerPersistentContainer>, ObvErrorMaker {
    ...
    enum ObvMessengerModelVersion: String {
        ...
        case version72 = "ObvMessengerModel-v72"
    ...
    public override func modelVersion(_ rawModelVersion: String, isMoreRecentThan otherRawModelVersion: String?) throws -> Bool {
    ...
    public override func getNextManagedObjectModelVersion(from sourceModel: NSManagedObjectModel) throws -> (destinationModel: NSManagedObjectModel, migrationType: DataMigrationManager<ObvMessengerPersistentContainer>.MigrationType) {
        ...
        case .version71: migrationType = .lightweight; destinationVersion = .version72
        ...
        case .version74: migrationType = .heavyweight; destinationVersion = .version74
        }
