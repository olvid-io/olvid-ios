...
/// This utility class is used in a non-concurrent context, so we can mark it as `@unchecked Sendable`.
final class UtilsForAppMigrationV19ToV20: @unchecked Sendable {
