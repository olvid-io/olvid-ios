...
// Ok
@objc(PersistedObvContactDeviceToPersistedObvContactDeviceV58ToV59)
final class PersistedObvContactDeviceToPersistedObvContactDeviceV58ToV59: NSEntityMigrationPolicy {

    let log = OSLog(subsystem: ObvAppCoreConstants.logSubsystem, category: "PersistedObvContactDeviceToPersistedObvContactDeviceV58ToV59")
