...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedMessageSystemToPersistedMessageSystemMigrationPolicyV9ToV10]"


final class PersistedMessageSystemToPersistedMessageSystemMigrationPolicyV9ToV10: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let dPersistedMessageSystem = try initializeDestinationInstance(forEntityName: entityName,
                                                                        forSource: sInstance,
                                                                        in: mapping,
                                                                        manager: manager,
        ...
        dPersistedMessageSystem.setValue(dSectionIdentifier, forKey: "sectionIdentifier")
        ...
        manager.associate(sourceInstance: sInstance, withDestinationInstance: dPersistedMessageSystem, for: mapping)
