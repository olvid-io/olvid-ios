...
fileprivate let debugPrintPrefix = "[\(errorDomain)][PersistedDiscussionGroupLockedToPersistedDiscussionGroupLockedMigrationPolicyV24ToV25]"


// Tested
final class PersistedDiscussionGroupLockedToPersistedDiscussionGroupLockedMigrationPolicyV24ToV25: NSEntityMigrationPolicy {
    ...
    override func createDestinationInstances(forSource sInstance: NSManagedObject, in mapping: NSEntityMapping, manager: NSMigrationManager) throws {
        ...
        let entityName = "PersistedDiscussionGroupLocked"
