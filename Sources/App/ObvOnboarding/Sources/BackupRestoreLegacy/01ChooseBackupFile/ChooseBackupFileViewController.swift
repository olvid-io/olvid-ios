...
final class ChooseBackupFileViewController: UIHostingController<ChooseBackupFileView>, ChooseBackupFileViewActionsProtocol, UIDocumentPickerDelegate {
    ...
    ///  Allows to store the seed entered by the user in the new backup flow.
    private var backupSeedManuallyEntered: BackupSeed?
    ...
    func setBackupSeedManuallyEntered(backupSeedManuallyEntered: BackupSeed?) {
        self.backupSeedManuallyEntered = backupSeedManuallyEntered
    }
    ...
    func userWantsToProceedWithBackup(encryptedBackup: Data) async {
        Task { [weak self] in
            ...
            await delegate?.userWantsToProceedWithLegacyBackup(controller: self, encryptedBackup: encryptedBackup, backupSeedManuallyEntered: backupSeedManuallyEntered)
        }
    }
