...
struct OwnedIdentityTransferFailureView: View {
    ...
    private static func localizedStringKeyForErrorThrownByTransferProtocol(_ error: OwnedIdentityTransferError) -> LocalizedStringKey? {
        ...
        case .couldNotGenerateObvChannelServerQueryMessageToSend,
                ...
                .couldNotObtainKeycloakConfiguration,
                ...
                VStack {
                    ...
                    HStack {
                        VStack(alignment: .leading) {
                            ...
                            Text("OWNED_IDENTITY_TRANSFER_FAILED_BODY_\(ObvAppCoreConstants.toEmailForSendingInitializationFailureErrorMessage)")
                                .font(.body)
                                .foregroundStyle(.primary)
                                .padding(.bottom, 4)
                            ...
                            HStack {
                                Spacer()
                                Button("COPY_ERROR_TO_PASTEBOARD".localizedInThisBundle) {
