...
public protocol NewAutorisationRequesterViewControllerDelegate: AnyObject {
...
public final class NewAutorisationRequesterViewController: UIHostingController<NewAutorisationRequesterView>, NewAutorisationRequesterViewActionsProtocol {
    
    public enum AutorisationCategory {
    ...
    public init(autorisationCategory: AutorisationCategory, delegate: NewAutorisationRequesterViewControllerDelegate) {
