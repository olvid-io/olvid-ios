...
final class IdentityProviderValidationViewController: UIHostingController<IdentityProviderValidationView>, IdentityProviderValidationViewActionsProtocol {
    ...
    private let keycloakConfiguration: ObvKeycloakConfiguration
    ...
    func discoverKeycloakServer(keycloakServerURL: URL) async throws -> (jwks: ObvJWS.ObvJWKSet, serviceConfig: OIDServiceConfiguration) {
