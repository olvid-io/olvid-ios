...
open class OperationWithSpecificReasonForCancel<ReasonForCancelType: LocalizedErrorWithLogType>: Operation, @unchecked Sendable {
    
    public var reasonForCancel: ReasonForCancelType?
    public var assertionFailureInCaseOfFault = true
    ...
    public func logReasonIfCancelled(log: OSLog) {
        ...
        if reason.logType == .fault && assertionFailureInCaseOfFault {
            assertionFailure()
        }
    }
