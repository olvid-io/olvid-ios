...
public struct ObvGenericIdentity: ObvIdentity, Sendable {
    
    public let cryptoId: ObvCryptoId
    public let currentIdentityDetails: ObvIdentityDetails
        
    public init(cryptoIdentity: ObvCryptoIdentity, currentIdentityDetails: ObvIdentityDetails) {
    ...
    public init(cryptoIdentity: ObvCryptoIdentity, currentCoreIdentityDetails: ObvIdentityCoreDetails) {
        self.cryptoId = ObvCryptoId(cryptoIdentity: cryptoIdentity)
    ...
    public func getDisplayNameWithStyle(_ style: ObvIdentityCoreDetails.DisplayNameStyle) -> String {
        return currentIdentityDetails.getDisplayNameWithStyle(style)
    }
