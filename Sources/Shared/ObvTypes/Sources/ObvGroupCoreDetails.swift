...
public struct ObvGroupCoreDetails: Equatable, Sendable, Hashable {
    
    public let name: String
    public let description: String?

    private static let errorDomain = String(describing: ObvGroupCoreDetails.self)
...
extension ObvGroupCoreDetails: Codable {
    ...
    public init(_ data: Data) throws {
        ...
        self = try decoder.decode(ObvGroupCoreDetails.self, from: data)
    }
