...
public struct ObvMessageIdentifier: Equatable, Hashable, CustomDebugStringConvertible {
    ...
    public let uid: UID // In case of a received message, this is the messageUIDFromServer.
    ...
    public init(ownedCryptoId: ObvCryptoId, uid: UID) {
        self.init(ownedCryptoIdentity: ownedCryptoId.cryptoIdentity, uid: uid)
    }
